...
import { FiHome, FiEdit, FiMic, FiLink, FiUsers, FiCheckSquare, FiLogOut, FiSettings, FiBarChart2, FiMusic, FiChevronLeft, FiChevronRight, FiVideo, FiClipboard, FiDatabase, FiDisc } from 'react-icons/fi';
...
const navItems = [
  ...
  { href: "/dashboard/song-requests", label: "Song Requests", icon: FiDisc, roles: ["MUSIC", "DEVELOPER", "TECHNIC", "REPORTER", "KRU"] },
